        ...
        >
          ...
          {showMoreFilters && (
            <div className="mt-3 w-full space-y-4">
              ...
              {/* El estado del inmueble no es un equipamiento: va aparte para
                  que "Acondicionado" no se lea como "Aire acondicionado". */}
