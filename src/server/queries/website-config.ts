...
export type FeaturesProps = {
  ...
  sections?: {
    ...
    /** Networks shown in the v2 social section. Parsed on v1, not rendered. */
    socialFamilyPlatforms?: string[];
  };
  menuLabels?: {
    segundaMano?: string;
    alquilar?: string;
   ...
   * top-nav entry while the contact section stays reachable.
   */
  contactoInNav?: boolean;
  /** Show the "Enlaces de interés" navbar link. Default true. v1 only. */
...
export const getFeaturesProps = (_accountIdArg?: bigint): FeaturesProps => {
  ...
  "sections": {
  "socialFamily": true,
  "socialFamilyPlatforms": ["instagram", "tiktok", "facebook", "youtube"]
},
...
export const getSEOConfig = (): SEOConfig => {
  ...
  "keywords": "león, bierzo, galicia, casas, inmobiliaria, pisos, montaña, venta",
  "name": "",
  "email": "hola@ecogar.es",
  "telephone": "+34665203040",
  "url": "https://www.ecogar.es",
  "ogTitle": "",
  "ogDescription": "",
  "ogImage": "",
  "ogType": "website",
